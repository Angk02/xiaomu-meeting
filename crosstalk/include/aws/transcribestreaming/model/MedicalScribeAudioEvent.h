...
{
  /**
   * <p>A wrapper for your audio chunks</p> <p>For more information, see <a
   * href="https://docs.aws.amazon.com/transcribe/latest/dg/event-stream.html">Event
   * stream encoding</a>. </p><p><h3>See Also:</h3>   <a
   * href="http://docs.aws.amazon.com/goto/WebAPI/transcribe-streaming-2017-10-26/MedicalScribeAudioEvent">AWS
   * API Reference</a></p>
   */
  ...
  public:
    ...
    AWS_TRANSCRIBESTREAMINGSERVICE_API MedicalScribeAudioEvent(Aws::Vector<unsigned char>&& value) { m_audioChunk = std::move(value); }
    ...
    inline MedicalScribeAudioEvent& WithAudioChunk(const Aws::Vector<unsigned char>& value) { SetAudioChunk(value); return *this;}
    inline MedicalScribeAudioEvent& WithAudioChunk(Aws::Vector<unsigned char>&& value) { SetAudioChunk(std::move(value)); return *this;}
    ///@}
